...
// 引導禱告 + 抽卡的溫和提醒文案（依日期輪替，當天所有人一致）
const MESSAGES: { title: string; body: string }[] = [
  { title: '今日的箴言在等你', body: '靜下心，向神禱告片刻，再來領受今天的話語。' },
  { title: '新的一天，先與神對話', body: '邀請你禱告交託，然後翻開今日的箴言卡。' },
  { title: '今天還沒抽卡喔', body: '安靜下來向神祈求，讓一句話陪你走過這一天。' },
  { title: '留一點時間給神', body: '先禱告，再抽今日箴言 — 願這句話成為你的光。' },
]
